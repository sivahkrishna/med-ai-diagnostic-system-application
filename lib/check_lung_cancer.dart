...
// import 'dart:io';
//
// class check_lung_cancer extends StatefulWidget {
//   @override
//   check_lung_cancer_state createState() => check_lung_cancer_state();
// }
//
// class check_lung_cancer_state extends State<check_lung_cancer> {
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text("Please select a CT scan image"),
//           backgroundColor: Colors.red,
//         ),
//       );
//       return;
...
//
//       var request = http.MultipartRequest("POST", Uri.parse(url.toString() + "/lung_cancer_predict"));
...
//                       child: Row(
//                         children: [
//                           Icon(Icons.air_outlined, color: Colors.white, size: 14),
...
//                           Text(
//                             "Upload CT scan for AI-powered analysis",
...
//                                 ),
//                                 child: Center(
//                                   child: Icon(Icons.air_outlined, color: primary, size: 24),
//                                 ),
//                               ),
...
//                               decoration: BoxDecoration(
//                                 color: _displayText.toLowerCase().contains('positive')
...
//                                 const SizedBox(height: 4),
//                                 Text(
//                                   "Supported formats: JPG, PNG, DICOM. Ensure clear visibility of lung region for accurate analysis.",
//                                   style: poppinsRegular.copyWith(
//                                     color: primaryLight,
//                                     fontSize: 12,
//                                   ),
...
class check_lung_cancer_state extends State<check_lung_cancer> with SingleTickerProviderStateMixin {
  final txtname = TextEditingController();
  final txtphone = TextEditingController();
  ...
  void _showResultPopup(String result) {
    bool isPositive = result.toLowerCase().contains('positive') ||
        result.toLowerCase().contains('cancer') ||
        result.toLowerCase().contains('malignant') ||
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              "Upload CT scan for AI analysis",
                              style: poppinsMedium.copyWith(
                                color: primaryLight,
                                fontSize: 14,
                              ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(Icons.air_outlined, color: primary, size: 16),
                                const SizedBox(width: 8),
                                Text(
                                  "CT Scan Image",
                                  style: poppinsSemiBold.copyWith(
                        ...
                        if (_finalResult.isNotEmpty && !_isAnalyzing) ...[
                          ...
                          Container(
                            ...
                            padding: const EdgeInsets.all(20),
                            decoration: BoxDecoration(
                              color: _finalResult.toLowerCase().contains('positive') ||
                                  _finalResult.toLowerCase().contains('cancer') ||
                                  _finalResult.toLowerCase().contains('malignant')
